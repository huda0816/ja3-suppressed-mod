return PlaceObj('ModDef', {
	...
	'last_changes', "v2.0\n\n[list]\n[*]Changed msg hook as used hook was removed\n[*]Distance plays a greater role \n[*]Units can keep suppression if it was too high and the suppression resistance is not high enough\n[/list]",
	'id', "ANKmKG",
	'author', "permanent666",
	'version_major', 2,
	'version', 1202,
